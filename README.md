...
Le programme **test_kb.py** permet de visualiser les codes émmis par les touches du (des) claviers connectés.
Utilisez ce programme pour paramétrer le fichier fichier config.ini.
...
The program **test_kb.py** can be used to print the keycodes generated by the connected keyboards.
Use this program tu configure the config.ini file.
